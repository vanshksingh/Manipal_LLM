...
Refuse potentially bad requests. Functions Auto fetch current time.
"""
...
if len(msgs.messages) == 0:
    msgs.add_ai_message(
        "Providing you with clear, accurate information and helpful tools—ready to assist with any query, from schedules to faculty insights, whenever you need it."
    )
# Set the page title
st.title("QueryWise")
...
# React to user input
if input_text := st.chat_input("How can I assist you today?"):
